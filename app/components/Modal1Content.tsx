      ...
      <form>
        ...
        <div className="flex items-start justify-end gap-4 pt-12">
          ...
          <button
            ...
            className=" btn col-span-3 flex !gap-[6px] !rounded !border-none bg-gradient-to-r from-[#4576F6] to-[#0C49E7] px-6 py-3 text-lg  !font-medium !capitalize text-[#fff] hover:bg-[#380Eff]"
          >
            Add User
          </button>
        </div>
